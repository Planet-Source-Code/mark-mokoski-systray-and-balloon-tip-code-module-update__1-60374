Attribute VB_Name = "modSystray"
    ...
    Public multiTip                            As Boolean 'In shell32.dll ver 5, exploit "bug" and allow multi balloon tips
    ...
    Public Const NIIF_GUID                     As Long = &H4 'Ver 6 of Shell32.dll (WinXP SP2) only
...
Public Sub PopupBalloon(frm As Form, Message As String, Title As String, Optional DispIcon As Integer)
    ...
    If multiTip = False Then Call RemoveBalloon(frm)
        ...
        With vbTray
            ...
            'Choose the message icon below, NIIF_NONE, NIIF_WARNING, NIIF_ERROR, NIIF_INFO, NIIF_GUID in shell32.dll V6 only
            .dwInfoFlags = DispIcon  'NIIF_GUID in shell32.dll V6 only
        End With
